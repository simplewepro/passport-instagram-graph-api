...
function Strategy(options, verify) {
  ...
  options.profileFields = Array.isArray(options.profileFields) ? options.profileFields : ['username', 'media_count', 'id', 'account_type'];
  
  OAuth2Strategy.call(this, options, verify);
  this.name = 'instagram';
  this._profileURL = 'https://graph.instagram.com/me?fields=' + options.profileFields.join(',');
}
